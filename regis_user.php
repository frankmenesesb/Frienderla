...
$cumple = trim($_REQUEST['cumpleanos']);
$telefono = htmlspecialchars(trim($_REQUEST['telefono']));
$genero = htmlspecialchars(trim($_REQUEST['genero']));
$pais = htmlspecialchars(trim($_REQUEST['pais']));
$region = htmlspecialchars(trim($_REQUEST['region']));
